...
object= Fraction(int(input("Введите значение числителя первой дроби: ")),
                int(input("Введите значение знаменателя первой дроби: ")),
                int(input("Введите значение числителя второй дроби: ")),
                int(input("Введите значение знаменателя второй дроби: ")))
object.add()
object.sub()
object.div()
object.mul()
